...
5)
%==========================================================%
•	The mean $\pm$  1 standard deviation includes 68% of the observations ,leaving 16% (approx) in each tail.

•	The mean $\pm$  1.96 standard deviation includes 95% of the observations ,leaving 2.5 % (approx) in each tail.
   
•	The mean $\pm$  2.58 standard deviation includes 99% of the observations ,leaving 0.5 % (approx) in each tail.
%==========================================================%
